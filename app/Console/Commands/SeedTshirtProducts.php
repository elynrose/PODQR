...
class SeedTshirtProducts extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'seed:tshirt-products';
     ...
     * @var string
     */
    protected $description = 'Seed essential T-shirt products for cloud deployment';
    ...
    {
        $this->info('Seeding essential T-shirt products...');
        ...
        foreach ($products as $product) {
            $existing = Product::where('printful_id', $product['printful_id'])->first();
        ...
        $totalTshirts = Product::where('type', 'T-shirt')->where('is_active', true)->count();
        $this->info("Total active T-shirt products: {$totalTshirts}");
    }
} 